...
import { ActionButton } from '@/src/shared/ui/components/ActionButton'; // Import ActionButton
                ...
                <div className="overflow-x-auto">
                    <div className="min-w-[1000px]">
                        ...
                        <Table
                            ...
                            emptyMessage="Belum ada data mustahiq"
                        />

            ...
            <Card className="overflow-hidden">
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="border border-gray-100 dark:border-dark-border rounded-lg p-4 flex items-center gap-3">
                        ...
                        <div className="border border-gray-100 dark:border-dark-border rounded-lg p-4 flex items-center gap-3">
                            <div className={`p-2 rounded-lg ${program.active ? 'bg-green-50 dark:bg-green-900/20 text-green-600 dark:text-green-400' : 'bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400'}`}>
                                {program.active ? <CheckCircle className="w-5 h-5" /> : <XCircle className="w-5 h-5" />}
                            </div>
                            <div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-6 pt-2 border-t border-gray-100 dark:border-dark-border pt-6">

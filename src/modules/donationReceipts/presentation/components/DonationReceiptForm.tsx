...
import { DonationReceiptFormValues } from '../../domain/donationReceipts.types';

export interface MuzakkiOption {
    id: string;
    name?: string;
    full_name?: string;
}
...
interface DonationReceiptFormProps {
    register: UseFormRegister<DonationReceiptFormValues>;
    errors: FieldErrors<DonationReceiptFormValues>;
    control: Control<DonationReceiptFormValues>;
    watch: UseFormWatch<DonationReceiptFormValues>;

    fields: UseFieldArrayReturn<DonationReceiptFormValues, "items">['fields'];
    append: UseFieldArrayReturn<DonationReceiptFormValues, "items">['append'];
    remove: UseFieldArrayReturn<DonationReceiptFormValues, "items">['remove'];

    onSubmit: () => void;
    isLoading: boolean;
    error: string | null;

    muzakkiList: MuzakkiOption[];
            ...
            <form onSubmit={onSubmit} className="space-y-8">
                ...
                <div>
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-text-primary mb-4">
                        {isEditMode ? 'Edit Informasi Kwitansi' : 'Informasi Kwitansi Baru'}
                    </h3>
                ...
                <div className="flex items-center justify-end gap-3 pt-4">
                    ...
                    <Button type="submit" isLoading={isLoading}>
                        {isEditMode ? 'Update Penerimaan' : 'Simpan Penerimaan'}
                    </Button>
                </div>
            </form>
        </Card>
